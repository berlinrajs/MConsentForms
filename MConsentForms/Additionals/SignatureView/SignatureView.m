...
- (void)_setupDefaultValues {
    self.foregroundLineColor = [UIColor blackColor];
...
- (void)pan:(UIPanGestureRecognizer *)pan {
    ...
    if ([pan state] == UIGestureRecognizerStateBegan) {
        ...
        if (self.delegate && [self.delegate respondsToSelector:@selector(drawingCompleted:signView:)]) {
            [self.delegate drawingCompleted:self.image signView:self];
        }
